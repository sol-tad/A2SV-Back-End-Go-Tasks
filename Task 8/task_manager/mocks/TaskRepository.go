...
func (_m *TaskRepository) GetAllTasks() ([]models.Task, error) {
	ret := _m.Called()
...
func (_m *TaskRepository) GetTaskByID(id string) (models.Task, error) {
	ret := _m.Called(id)
...
func (_m *TaskRepository) UpdateTask(id string, task models.Task) (models.Task, error) {
